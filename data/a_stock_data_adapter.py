...
# 2026-06-28 阶段4:板块同花顺 ths 兜底(行业/概念 涨跌排名 + 资金流)已归位 data/sources/akshare.py
# (末位整合库层)。这里保留原私有函数名作再导出,类方法 get_sector_ranking_ths/get_sector_fund_flow_ths
# 与 datahub 路由零改;原 _f_num 仅这两函数用,随之删除。
from data.sources.akshare import (   # noqa: E402
    sector_ranking as _sector_ranking_ths,
    sector_fund_flow as _sector_fund_flow_ths,
)
