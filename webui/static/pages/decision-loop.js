...
export default {
  ...
  setup() {
    const s=reactive({data:null,error:'',loading:false,previous:null,cash:'',allowAdd:false,previewing:false,plan:null})
    ...
    onMounted(load)
    return {s,status,baseline,bookName,hypothesis,percent,action,load,preview,cls,fmt}
  }
}
