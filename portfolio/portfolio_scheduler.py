...
class PortfolioScheduler:
    ...
    def __init__(self):
        ...
        self.analysis_mode = "parallel"  # ⭐ 默认改为并行分析
    ...
    def _scheduled_job(self):
        ...
        try:
            ...
            #   PORTFOLIO_DEEP_EXCLUDE_ETF=true(默认)排 ETF/基金;PORTFOLIO_DEEP_TOP_N=20(默认)
            ...
            _top_n = int(_os.getenv('PORTFOLIO_DEEP_TOP_N', '20') or 0) or None
