...
-- Explicit external research lane.  These tables cannot publish formal selection
-- membership and never contain execution prices or private browsing history.
...
CREATE TABLE IF NOT EXISTS notification_deliveries (
    delivery_id TEXT PRIMARY KEY, message_id TEXT NOT NULL REFERENCES notification_messages(message_id),
