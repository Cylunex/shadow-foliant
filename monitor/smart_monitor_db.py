...
class SmartMonitorDB:
    ...
    def __init__(self, db_file: str = _bootstrap.db_path('smart_monitor.db')):
        """
        初始化数据库
    ...
    def log_system_event(self, level: str, module: str, message: str, details: str = None):
        ...
        cursor.execute('''
            INSERT INTO smart_monitor_logs (log_level, module, message, details)
            VALUES (?, ?, ?, ?)
