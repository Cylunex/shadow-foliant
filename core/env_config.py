...
SCHEMA: List[Dict[str, str]] = [
    # —— LLM ——
    {'key': 'DEEPSEEK_API_KEY', 'label': 'DeepSeek API Key', 'group': 'LLM', 'type': 'secret',
     'help': '多智能体 / AI 研判必填'},
    {'key': 'DEEPSEEK_BASE_URL', 'label': 'DeepSeek Base URL', 'group': 'LLM', 'type': 'text',
     'help': '方舟Ark地址，如 https://ark.cn-beijing.volces.com/api/coding/v3'},
    {'key': 'DEFAULT_MODEL_NAME', 'label': '默认模型', 'group': 'LLM', 'type': 'text',
     'help': '如 deepseek-v4-pro / qwen-plus 等'},
    {'key': 'EM_API_KEY', 'label': '妙想东财 Key', 'group': 'LLM', 'type': 'secret',
